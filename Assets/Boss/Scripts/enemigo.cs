...
public class enemigo : MonoBehaviour
{
    ...
    public int reduccionDeDanioConEscudo; // 50% de reducción de daño
    ...
    private void ReducirDanio()
    {
        Vida playerHealth = player.GetComponent<Vida>();

        reduccionDeDanioConEscudo = (damage * 50) / 100;

        playerHealth.TakeDamage(reduccionDeDanioConEscudo);
